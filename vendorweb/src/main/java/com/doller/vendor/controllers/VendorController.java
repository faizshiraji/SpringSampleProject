package com.doller.vendor.controllers;
...
import com.doller.vendor.service.VendorService;
...
public class VendorController {
	...
	public String saveVendor(@ModelAttribute("vendor") Vendor vendor, ModelMap modelMap) {
		...
		String msg = "Your Vendor saved with ID No.: " + vendorSaved.getId();
	...
	public String deleteVendor(@RequestParam("id") int id, ModelMap modelMap) {
		//Vendor vendor = service.getVendorById(id).getId();
